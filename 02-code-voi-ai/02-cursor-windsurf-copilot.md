...
Cả bốn công cụ đều có **bản miễn phí hoặc dùng thử** - nhưng đừng hiểu nhầm là dùng thoải mái chế độ agent/Cascade mãi mãi ở bản này. Autocomplete cơ bản thường rộng rãi, nhưng agent mode (thứ bài này vừa giới thiệu ở Cursor/Windsurf) tính theo một số lượt "agent"/"premium request" giới hạn mỗi tháng ở bản miễn phí - và một tác vụ agent đơn lẻ (đọc nhiều file, sửa, tự kiểm tra lại) có thể tốn nhiều lượt cùng lúc, nên hết hạn mức rất nhanh nếu dùng agent mode hàng ngày *(kiểm tra: 07/09/2026)*. Muốn dùng agent mode đều đặn thay vì chỉ thử cho biết, thực tế cũng cần lên gói trả phí - mức phổ biến quanh 22 USD/tháng <Vnd usd="20" sau="/tháng" /> sau khi cộng VAT VN (hãng niêm yết khoảng 20 USD), không khác nhiều so với Claude Code/Codex đã học ở bài trước. Vì các công ty này thường xuyên đổi cấu trúc gói (thêm/bớt tính năng, đổi giá), **đừng tin vào con số cố định** - kiểm tra trực tiếp trang chủ từng công cụ để có giá mới nhất:
- Cursor: cursor.com
