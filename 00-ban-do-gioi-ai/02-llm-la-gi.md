# LLM là gì? Token, context, temperature - không cần biết toán
...
<path d="M240 70 V98 M235 91 L240 98 L245 91" style="fill:none;stroke:var(--vp-c-text-2);stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round"/>
  <rect class="mh-anim" x="164" y="100" width="152" height="46" rx="4" style="fill:var(--vp-c-brand-1);fill-opacity:.08;stroke:var(--vp-c-brand-1);stroke-opacity:1;stroke-width:2;animation:mh-tok-g 6s ease-in-out infinite !important"/>
