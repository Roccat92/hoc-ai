...
<svg id="mh-cost" viewBox="0 0 480 206" width="100%" role="img" aria-label="Ba văn bản dài dần tương ứng số token tăng dần, tiền tính theo số token" style="font-family:inherit;display:block">
  ...
  <rect class="mh-anim" x="190" y="32" width="8" height="16" rx="2" style="fill:var(--vp-c-brand-1);fill-opacity:.35;transform-box:fill-box;transform-origin:left center;animation:mh-cost-g 5.5s ease-in-out infinite !important;animation-delay:0s !important"/>
  ...
  <rect class="mh-anim" x="190" y="72" width="50" height="16" rx="2" style="fill:var(--vp-c-brand-1);fill-opacity:.35;transform-box:fill-box;transform-origin:left center;animation:mh-cost-g 5.5s ease-in-out infinite !important;animation-delay:0.4s !important"/>
  ...
  <rect class="mh-anim" x="190" y="112" width="180" height="16" rx="2" style="fill:var(--vp-c-brand-1);fill-opacity:.35;transform-box:fill-box;transform-origin:left center;animation:mh-cost-g 5.5s ease-in-out infinite !important;animation-delay:0.8s !important"/>
