...
<path d="M106 60 H152 M145 55 L152 60 L145 65" style="fill:none;stroke:var(--vp-c-text-2);stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round"/>
  ...
  <rect class="mh-anim" x="256" y="40" width="40" height="40" rx="3" style="fill:var(--vp-c-brand-1);fill-opacity:.3;stroke:var(--vp-c-brand-1);stroke-opacity:1;stroke-width:2;animation:mh-rag-p 5.5s ease-in-out infinite !important"/><text x="276" y="65" style="fill:var(--vp-c-text-2);font-size:12px;text-anchor:middle">3</text>
  ...
  <rect class="mh-anim" x="352" y="40" width="40" height="40" rx="3" style="fill:var(--vp-c-brand-1);fill-opacity:.3;stroke:var(--vp-c-brand-1);stroke-opacity:1;stroke-width:2;animation:mh-rag-p 5.5s ease-in-out infinite !important"/><text x="372" y="65" style="fill:var(--vp-c-text-2);font-size:12px;text-anchor:middle">5</text>
  ...
  <circle class="mh-anim mh-dot" cx="276" cy="100" r="4" style="fill:var(--vp-c-brand-1);stroke:none;animation:mh-rag-d 5.5s ease-in-out infinite !important"/>
