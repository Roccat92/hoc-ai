...
// - <Hero />: khối hero trang chủ (value prop + CTA + "bắt đầu ở đâu"), dùng ở README.md
...
// - <Reasoning />: playground reasoning cao/thấp - đánh đổi chính xác vs thời gian/token, bài 00-02
...
export default {
  ...
  enhanceApp({ app }) {
    ...
    app.component('Reasoning', Reasoning)
  }
}
